...
## 2026-03-20 合并剧本上传与主体解析导入功能

- [x] 读取剧本 Tab 上传功能实现
- [x] 合并：批量导入完成后自动触发 analyzeScriptFull，将人物/场景/道具导入主体库
- [x] 删除主体 Tab 中独立的「剧本解析导入」按鈕和对话框
- [x] 对话框底部显示拆解状态：拆解中→AI 解析主体中→完成结果

## 2026-03-20 单集导入触发主体解析 + 主体 Tab 刷新提示
